...
@Controller
public class RadioSelectController {

    private final DeptService deptService;
    private final RadioSelectService radioSelectService;

    public RadioSelectController(DeptService deptService, RadioSelectService radioSelectService) {
        this.deptService = deptService;
        this.radioSelectService = radioSelectService;
    }

    @GetMapping("/radioselect/kcsList")
    public String kcsList(Model model, RadioSelectVO radioSelectVO){
        ...
        return "radioselect/kcsList";
    }

    @GetMapping("/radioselect/kcsForm")
    public String kcsForm(Model model, RadioSelectVO radioSelectVO){
        ...
        return "radioselect/kcsForm";
    }

    @PostMapping("/updateRadioSelectKcs")
    public String updateRadioSelectKcs(Model model, RadioSelectVO radioSelectVO){
        ...
        return "redirect:/radioselect/kcsList";
    }
}
