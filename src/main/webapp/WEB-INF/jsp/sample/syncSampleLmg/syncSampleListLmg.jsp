        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Sample리스트 이민규</h1>
                </div>

                <!-- 요기가 컨텐츠 -->
                <form:form action="/syncSampleListLmg" method="get">
                ...
                <table class="table table-striped">
                    ...
                    <c:forEach var="list" items="${syncSampleList}" varStatus="status">
                        <tr>
                            ...
                            <td><a href="<c:url value='/syncSampleFormLmg?userId=${list.userId}' />">${list.userId}</a></td>
                            <td>${list.userName}</td>
