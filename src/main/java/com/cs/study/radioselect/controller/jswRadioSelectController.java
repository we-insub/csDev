...
@Controller
public class jswRadioSelectController {

    private final DeptService deptService;
    private final RadioSelectService radioSelectService;

    public jswRadioSelectController(DeptService deptService, RadioSelectService radioSelectService) {
        this.deptService = deptService;
        this.radioSelectService = radioSelectService;
    }

    @GetMapping("/radioselect/jswList")
    public String jswList(Model model, RadioSelectVO radioSelectVO){
        ...
        return "radioselect/jswList";
    }

    @GetMapping("/radioselect/jswForm")
    public String jswForm(Model model, RadioSelectVO radioSelectVO){
        ...
        RadioSelectVO sRsVO = radioSelectService.selectRadioSelectOne(radioSelectVO);
        model.addAttribute("sRsVO", sRsVO);
  
        return "radioselect/jswForm";
    }

    @PostMapping("/updateRadioSelectJsw")
    public String updateRadioSelectJsw(Model model, RadioSelectVO radioSelectVO){
        radioSelectService.updateRadioSelect(radioSelectVO);
      
        return "redirect:/radioselect/jswList";
    }
}
