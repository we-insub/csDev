        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">이민규 List</h1>
                </div>

                <form:form id="frm" name="frm" action="/updateRadioSelectLmg" method="post">
                    ...
                    <div class="form-group">
                        <label for="select2">select1</label>
                        <%--셀렉트로 바꾸기--%>
                        <select class="form-control" id="select1" name="select1">
                            <c:forEach var="map" items="${select01List}" varStatus="status">
                            <option value="${map.deptCode}">${map.deptName == "select1"?  'selected': ""}${map.deptName}</option>
                            </c:forEach>
                            </select>
                    </div>
                    <div class="form-group">
